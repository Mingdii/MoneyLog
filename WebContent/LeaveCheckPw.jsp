...
<script type="text/javascript">
	...
	$(function()
	{
		$("#leavePw-btn").click(function()      
		{
			...
			$("#leaveForm").submit();	// 서브밋 하면 myinfomodify.action 처리
				...
				<div class="col-md-12">
					...
					<div class="list-group">
						...
						<div class="list-group-item">
							<div class="list-group">
								<form action="leaveform.action" id="leaveForm">
	            					...
	            					<br>
									<button type="button" class="btn btn-primary" id="leavePw-btn" style="width:100%; background-color: #1fa766;"
									> 확인 </button>
