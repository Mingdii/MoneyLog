		...
		<div class="container-fixed m-4">
	        ...
	        <div class="row bg-light sign-up-form mt-3">
				<div class="sign-up-process col-12">
	                <form action="/MoneyLog/findpw.action" method="post" id="findpw">
						...
						<div class="row form-group">
							...
							<div class="col-4">
								<br>
								<button type="button" id="goSMS" name="goSMS" class="btn btn-primary">sms 전송</button>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-8">
